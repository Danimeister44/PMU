...
public class SettingsActivity extends AppCompatActivity {
    ...
    String[] cities = {"Subotica", "Novi Sad", "Beograd", "San Francisko", "Sidnej", "Sombor", "Svetozar Miletic"};
    ...
    public boolean onOptionsItemSelected(android.view.MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_refresh:
                ...
                refreshIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(refreshIntent);
                return true;
            case R.id.menu_pollution:
                String city = spinnerCity.getSelectedItem().toString();  // <-- Read from spinner directly
                ...
                if (coords != null) {
                    ...
                    pollutionIntent.putExtra("city", city);  // <-- Send city name too!
            ...
            case R.id.menu_history:
                ...
                historyIntent.putExtra("city", selectedCity);  // <-- Send city name
